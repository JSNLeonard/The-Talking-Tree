...
<!-- Form to submit stories and take a selfie -->
<form method="post" action="http://192.168.0.41:5000/send_story" enctype="multipart/form-data" onsubmit="submitFormOnce(this); return false;">
    <div class="form-group">
        <h1>Talking Tree (Story)</h1>
        <h5>Enter Your First & Last Name, Ask A Story & Take A Selfie Below</h5>
...
<script>
    ...
    photoUploadForm.addEventListener('submit', async (event) => {
        ...
        if (file) {
            ...
            const response = await fetch('http://192.168.0.41:5000/send_story', {
                method: 'POST',
                body: formData,
            });
