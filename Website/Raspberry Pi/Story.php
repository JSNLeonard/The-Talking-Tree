...
<body>
    ...
    <form method="post" action="http://192.168.0.61:5000/send_story" enctype="multipart/form-data" onsubmit="submitFormOnce(this); return false;">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="story" id="story" placeholder="Enter Your Story" required>
        </div>
        <div class="form-group">
