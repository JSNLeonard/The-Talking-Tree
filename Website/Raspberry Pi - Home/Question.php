...
<form method="post" action="http://192.168.0.60:5000/send_question" enctype="multipart/form-data" onsubmit="submitFormOnce(this); return false;">
...
<script>
    ...
    photoUploadForm.addEventListener('submit', async (event) => {
        ...
        if (file) {
            ...
            const response = await fetch('http://192.168.0.60:5000/send_question', {
                method: 'POST',
                body: formData,
            });
